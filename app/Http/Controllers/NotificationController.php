...
class NotificationController extends Controller
{
    ...
    public function sendSMS($id)
    {
        ...
        $sms_body = 'Dear '.$student->fname.' '.$student->sname.', you have a balance of K'.$balance.' from Daron Driving School due '.$due_date.'. Pay as as possible. <br> For more information Call/WhatsApp 0999532688. Best regards!';
