...
<div class="container invoice">
    ...
    <h3 style="text-transform: uppercase;">APPLICATION FOR 2nd APTITUDE TEST FOR CHIMWEMWE MBOMA</h3>

    <P style="text-align: justify;">This letter serves as a reference for {{$student->fname}} {{$student->sname}} to support his application for a Traffic Registers Card. {{$student->fname}} {{$student->sname}} is one of our students here at DARON DRIVING SCHOOL and would like to apply for a traffic register card.</P>
